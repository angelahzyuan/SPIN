...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=8 --main_process_port 2950 spin/run_spin.py configs/config.yaml --num_train_epochs=1 --output_dir="outputs/iter0-ckpt-num1-01" --beta=0.01
